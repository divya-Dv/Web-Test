    ...
    <script type="application/ld+json">
        {
            "@context": "https://schema.org/",
            "@type": "Product",
            "name": "DR Glove - Orthopedic Gloves Manufacturer",
            "image": "https://www.vlhsglove.com/img/orthopedicgloves-updated.jpg",
            "description": "Orthopedic Gloves Manufacturer. Well designed to provide extra protection for surgeons and offer extra thickness with a superior grip. visit our site.",
            "brand": {
                "@type": "Brand",
                "name": "Vijayalakshmi Health & Surgicals Pvt Ltd"
            },
                ...
                <div class="col-md-12">
                    ...
                    <div class="iheader" style="">
                        <div class="titlebar" style="padding-right:25px;">
                            <h1 class="entry-title">Orthopaedic Gloves</h1>
                            <div class="nx-breadcrumb"><!-- Breadcrumb NavXT 6.1.0 -->
                                <span property="itemListElement" typeof="ListItem">
                                    ...
                                    <span property="name">Orthopaedic Gloves</span>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="service-details-area">
                        <p>Dr.Glove-Ortho Surgical Gloves are well designed to provide extra protection for orthopedic surgeons and offering 30% extra thickness combined with its textured finish for superior grip when handling instruments</p>
                        <br>
                        <ul class="list">
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i> 30% thicker than the standard glove to withstand rigorous orthopaedic surgeries</li>
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i> Ergonomically designed for optimum fit and comfort</li>
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i> Provides extra protection during complicated or rigorous orthopaedic surgery, particularly against bone fragments and other surgical debris</li>
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i> Excellent synthetic coating. The glove is not powdered, but is leached several times and because it has very low levels of protein and other potential irritants, offers excellent skin compatibility and comfort.</li>
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i> Latex protein no more than 50µg of protein per dm2, eliminates risk of Latex Allergy</li>
                        </ul>
                        ...
                        <ul class="list">
                            ...
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i> Bioburden and sterility tested</li>
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i> Manufactured in a clean controlled environment Room</li>
                        </ul>

                        <h3 class="color">QUALITY CONTROL</h3>
                        <ul class="list">
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i> 100% Inspected</li>
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i> Factory Standard of ≤ 1.0 AQL for Pinholes. </li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div id="primary" class="content-area">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade active in" id="bs_first_tab25">
                                        <table border="0" width="100%" cellspacing="1" cellpadding="5">
                                            <tbody>
                                                <tr>
                                                    <th>Material</th>
                                                    <td>Natural high grade NR Latex.</td>
                                                </tr>
                                                <tr>
                                                    <th>Design &amp; Features</th>
                                                    <td>Hand Specific, Beaded Cuff, Micro rough textured, Brown Colour</td>
                                                </tr>
                                                <tr>
                                                    <th>Coated</th>
                                                    <td>Polymer</td>
                                                ...
                                                <tr>
                                                    <th>Extractable Protein Level</th>
                                                    <td>&lt; 200 μg/ dm2</td>
                                                </tr>
                                                <tr>
                                                    <th>Powder Residue</th>
                                                    <td>&lt; 2 mg/glove</td>
                                                </tr>
                                                <tr>
                                                    <th>Sterilization</th>
                                                    <td>Ethylene Oxide / Gamma irradiated as per customer requirement</td>
                                                </tr>
                                                <tr>
                                                    <th>Storage</th>
                                                ...
                                                <tr>
                                                    <th>Shelf Life</th>
                                                    <td>3 years from date of manufacturing</td>
                                                </tr>
                                                <tr>
                                                    <th>AQL(Factory Slandered)</th>
                                                    <td>≤ 1.0</td>
                                                </tr>
                                                <tr>
                                                    <th>Packing</th>
                                                    <td>*One pair in peel pouch<br>
                                                        *50 pairs in dispenser box<br>
                                                        *20 boxes in one carton</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    <div class="tab-pane fade " id="bs_tab121340625">
                                        <table class="table-list">
                                            <tbody>
                                                <tr>
                                                    <td style="background-color: #0095da; color: #fff;" colspan="2" scope="col"><strong style="color: #fff;">Dimension Properties</strong></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td style="text-align: center;">Min 280</td>
                                                ...
                                                <tr>
                                                    <th rowspan="3" scope="row" align="left">Thickness (mm)</th>
                                                    <td style="text-align: center;">Finger</td>
                                                    <td style="text-align: center;">0.26 Min</td>
                                                    <td style="text-align: center;">0.10 Min</td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align: center;">Palm</td>
                                                    <td style="text-align: center;">0.22 Min</td>
                                                    <td style="text-align: center;">0.10 Min</td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align: center;">Cuff</td>
                                                    <td style="text-align: center;">0.20 Min</td>
                                                    <td style="text-align: center;">0.10 Min</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="table-list">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <th style="background-color: #0095da; color: #fff;" scope="col">Dr.Glove Specification</th>
                                                    <th style="background-color: #0095da; color: #fff;" scope="col">ASTM D 3577 / IS 13422 Standard</th>
                                                </tr>
                                                <tr>
                                                    <th rowspan="3" scope="row" align="left">Before ageing</th>
                                                    <td>Tensile Strength (Mpa)</td>
                                                    <td>Min 24-28</td>
                                                    <td>24.0 Min</td>
                                                </tr>
                                                <tr>
                                                    <td align="left">Stress at 500% Elongation (Mpa)</td>
                                                    <td>Max 5</td>
                                                    <td>5.5 Max</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <th rowspan="2" scope="row" align="left">After Ageing</th>
                                                    <td>Tensile Strength (Mpa)</td>
                                                    <td>Min 22</td>
                                                    <td>18.0 Min</td>
                                                </tr>
                                                <tr>
                                                    <td scope="row" align="left">6Elongation At Break (%)</td>
                                                    <td>Min 750</td>
                                                    <td>560 Min</td>
                                                </tr>
                                                <tr>
                                                    <th scope="row" align="left">Water Tightness Test G-1</th>
                                                    <td></td>
                                                    <td>AQL ≤ 1.0</td>
                                                    <td>AQL 1.5</td>
                                                </tr>
                                                <tr>
                                                    <th scope="row" align="left">Protein Content, Max</th>
                                                    <td></td>
                                                    <td>&lt; 200 μg/ dm2</td>
                                                    <td></td>
                                                </tr>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="city" name="city" required="">
                        ...
                        <div class="at-below-post-page addthis_tool" data-url="http://www.vlhsglove.com/latex-surgical-gloves-powdered-free/"></div><!-- AddThis Share Buttons generic via filter on the_content -->
                    </div><!-- .entry-content -->
