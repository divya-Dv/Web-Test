    ...
    <body>
       ...
       <section class="medipath-banner">
            ...
            <div class="container">
				...
				<div class="titlebar">
					 <h1 class="entry-title">Surgical Gloves Manufacturers In Bangalore</h1>												
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 text_col">
                        <div class="medipath-details">
							...
							<h2>Surgical Gloves Manufacturers In Bangalore</h2>
                            <p>Conclude your search for a trusted and renowned Surgical Gloves Manufacturers In Bangalore.</p>
                        
                      <p style="margin-top: 15px;">Founded by a team of industry experts and visionaries, we have built our brand from scratch. Continue to reinvent the healthcare sector in small but sure steps. We offer a wide variety of gloves for varied applications. Which include latex surgical gloves – pre-powdered, latex surgical gloves – powder free.</p>
                      
                      <p style="margin-top: 15px;">Orthopedic gloves, latex examination gloves, and nitrile examination gloves. Each of our offerings is with great care and detail while understanding. The needs of patients and healthcare professionals. Whether it’s for generic tasks, minor procedures, or intricate surgery, we have a pair ready to go at a moment’s notice.</p>
                      <p style="margin-top: 15px;">At <b>Vijayalakshmi Health and Surgical Pvt. Ltd</b>, quality is not a catchphrase but a way of life. Our state-of-the-art production facility and a team of seasoned professionals make. It is their business to ensure every part of the production process as per guidelines.</p>
                        </div>
                    </div>
