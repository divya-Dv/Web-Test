...
<!-- End Google Tag Manager (noscript) -->
       ...
       <section class="medipath-banner">
            ...
            <div class="container">
				...
				<div class="titlebar">
					 <h1 class="entry-title">Surgical Gloves Manufacturers In Surat</h1>			
				  ...
				  <span property="name">Surgical Gloves Manufacturers In Surat</span><meta property="position" content="2"></div>
					 <div class="nx-breadcrumb"><!-- Breadcrumb NavXT 6.1.0 -->
                     <span property="itemListElement" typeof="ListItem">
        ...
        <section class="about section-padding">
            <div class="container">
                ...
                <div class="col-md-12 text_col">
                    <h3>Here is why you should choose us:</h3>
