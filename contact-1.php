...
<!-- End Google Tag Manager (noscript) -->
    ...
    <form role="form" method="post" action="enquiry.php">
		...
		<div class="row">
			<!--<div class="form-group">-->
			<!--	 <div class="g-recaptcha" style="transform:scale(0.77);-webkit-transform:scale(0.77);transform-origin:0 0;-webkit-transform-origin:0 0;" data-sitekey="6Lc1cb8UAAAAAP42TXEY4fnxXht0Ky6c2kQvF1-O"></div>-->
			<!--</div>-->
		</div>
        <div class="row">
            <div class="form-group">
                <button type="submit" name="submit" class="btn btn-lg btn-success btn-block">Post It! </button>
            </div>
        </div>
  ...
  <script>
var phoneNumber = "+91 77999 77314";
var phoneNumber1 = "+91 12345 67890";
document.getElementById("phone-number-text").textContent = phoneNumber;
document.getElementById("phone-number-text-1").textContent = phoneNumber1;
</script>
         <script>
