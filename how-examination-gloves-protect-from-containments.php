...
<head>
    ...
    <!-- End Google Tag Manager -->
    <!-- page title -->
    <title>How Examination Gloves Protect from Containments | Vlhsglove</title>
...
<meta property="og:description" content="Discover the high quality surical gloves from Vijayalakshmi Health & Surgicals Pvt Ltd and get exciting deals on our products visit us for deatils.">
    ...
    <meta name="description" content="Examination gloves are commonly used by medical professionals across the globe for performing medical procedures and examining patients. At Vlhsglove." />
    <link rel="canonical" href="https://www.vlhsglove.com/how-examination-gloves-protect-from-containments.php" />
    <!--Bootstrap css-->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="medipath-banner-header">
                        <h1 class="banner-title" >How Examination gloves protect from containments</h1>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                            <li class="breadcrumb-item active">How Examination gloves protect from containments</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-7 text_col">
                    <div class="medipath-details">
                        <div class="medipath-Welcome">
                            ...
                            <p>Examination gloves are commonly used by medical professionals across the globe for performing medical procedures and examining patients. The primary function of examination gloves is to protect the user from cross-contamination when handling a patient or potentially infectious or contaminated material. Examination gloves become a protective layer for the user that ensures that the skin doesn’t get exposed to the disease-causing micro-organism. Imagine working with paint – if you get paint on the gloves you are wearing, all you have to do is remove the gloves and your hands remain unaffected by it. The same principle applies in a medical scenario too.</p>
                            <br>
                            <p>Examination gloves are mainly made from latex which is a type of rubber. They are extremely flexible, durable and have high elasticity which allows the user to perform their task without losing their mobility while also ensuring they remain protected from contaminants and puncturing of the gloves. Depending on the specifics of the medical case, the quality, build and features of examination gloves may differ. However, the bottom line remains the same throughout; to provide protection to the patient and the medical professional from contracting any harmful pathogen. At VLHS, we provide a wide range of examination gloves that suit all possible medical scenarios while ensuring the users of unmatched performance and protection on any given day.</p>
                        </div><br>
                    </div>
                </div>
                <div class="col-md-5 img_col" style="padding-top:20px;">
                    <div class="medipath-details-img">
                        <img src="assets/img/Latex-Surgical-Gloves2.jpg" class="img-responsive" alt="How Examination Gloves Protect from Containments" title="The Best Health Tips and Tricks That Will Change Your Life" style="">
                    </div>
                </div>
            </div>
        </div>
