...
<!-- End Google Tag Manager (noscript) -->
       ...
       <section class="medipath-banner">
            ...
            <div class="container">
				...
				<div class="titlebar">
					 <h1 class="entry-title">Surgical Gloves Manufacturers In Pune</h1>
				  ...
				  <span property="name">Surgical Gloves Manufacturers In Pune</span><meta property="position" content="2"></div>
...
<li>Surgical gloves protect healthcare providers from coming in contact with infectious organisms present on the patient’s skin, tissue, or body fluids.</li>
<li>These gloves also protect the user from chemicals that may be used in surgical procedures.</li>
<li>The glove is designed to improve the dexterity and grip of the user while protecting the wearer throughout the procedure.</li>
</ul>
                         </div>
                    </div>
...
<h3>Why you should choose <b>Vijayalakshmi Health and Surgical Pvt. Ltd</b> Glove:</h3>
<ul class="ul_list" style="padding-left:20px;">
<li>Strict quality compliance underscores all our endeavours. We are an EN ISO-13485:2016, CE, and ISI-certified company.  This provides our partners with the confidence they need regarding our product's quality and performance.</li>
<li>The team comprises highly skilled and driven professionals from varied backgrounds. Each member has their work assigned and works in sync with others to improve the overall outcome of the production process.</li>
<li>We ensure they are provided with a seamless experience to ensure smooth workflow starting from initial consultation, sales, and after-sales support. This also helps in forging long-lasting business associations while improving the overall health outcome.</li>
