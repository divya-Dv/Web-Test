                    ...
                    <div class="grid">
                        <div class="col-md-3 col-sm-6 col-xs-12 padding grid-item metal">
                            <div class="portfolio-single-item">
                                ...
                                <div class="portfolio-overlay">
                                    <div class="zoom">
                                        <a href="assets/img/Compounding.jpg" class="portfolio-single"><i class="fa fa-search-plus"></i></a>
                                    </div>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 padding grid-item transition">
                            <div class="portfolio-single-item">
                                ...
                                <div class="portfolio-overlay">
                                    <div class="zoom">
                                        <a href="assets/img/Machine.jpg" class="portfolio-single"><i class="fa fa-search-plus"></i></a>
                                    </div>
									</div>
                           </div>
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 padding grid-item alkali">
                            <div class="portfolio-single-item">
                                ...
                                <div class="portfolio-overlay">
                                    <div class="zoom">
                                        <a href="assets/img/Formers.jpg" class="portfolio-single"><i class="fa fa-search-plus"></i></a>
                                    </div>
                                </div>
                           </div>
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 padding grid-item metal">
                            <div class="portfolio-single-item">
                                ...
                                <div class="portfolio-overlay">
                                    <div class="zoom">
                                        <a href="assets/img/Lab.jpg" class="portfolio-single"><i class="fa fa-search-plus"></i></a>
                                    </div>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 padding grid-item alkali">
                            <div class="portfolio-single-item">
                                ...
                                <div class="portfolio-overlay">
                                    <div class="zoom">
                                        <a href="assets/img/Tumbling.jpg" class="portfolio-single"><i class="fa fa-search-plus"></i></a>
                                    </div>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 padding grid-item transition">
                            <div class="portfolio-single-item">
                                ...
                                <div class="portfolio-overlay">
                                    <div class="zoom">
                                        <a href="assets/img/Testing.jpg" class="portfolio-single"><i class="fa fa-search-plus"></i></a>
                                    </div>
						...
						<div class="col-md-3 col-sm-6 col-xs-12 padding grid-item transition">
                            <div class="portfolio-single-item">
                                ...
                                <div class="portfolio-overlay">
                                    <div class="zoom">
                                        <a href="assets/img/Packing.jpg" class="portfolio-single"><i class="fa fa-search-plus"></i></a>
                                    </div>
						...
						<div class="col-md-3 col-sm-6 col-xs-12 padding grid-item transition">
                            <div class="portfolio-single-item">
                                ...
                                <div class="portfolio-overlay">
                                    <div class="zoom">
                                        <a href="assets/img/Sterilization.jpg" class="portfolio-single"><i class="fa fa-search-plus"></i></a>
                                    </div>
						...
						<div class="col-md-3 col-sm-6 col-xs-12 padding grid-item transition">
                            <div class="portfolio-single-item">
                                ...
                                <div class="portfolio-overlay">
                                    <div class="zoom">
                                        <a href="assets/img/Storage.jpg" class="portfolio-single"><i class="fa fa-search-plus"></i></a>
                                    </div>
						...
						<div class="col-md-3 col-sm-6 col-xs-12 padding grid-item transition">
                            <div class="portfolio-single-item">
                                ...
                                <div class="portfolio-overlay">
                                    <div class="zoom">
                                        <a href="assets/img/Delivery.jpg" class="portfolio-single"><i class="fa fa-search-plus"></i></a>
                                    </div>
						...
						<!--<div class="col-md-3 col-sm-6 col-xs-12 padding grid-item transition">-->
      <!--                      <div class="portfolio-single-item">-->
      <!--                          <img src="assets/img/Brainstorm.jpg" class="img-responsive" alt="Brainstorm">-->
						<!--		<div class="content">-->
						<!--		<h4 style="text-align:center;">Brainstorm</h4>-->
						<!--		</div>-->
      <!--                          <div class="portfolio-overlay">-->
      <!--                              <div class="zoom">-->
      <!--                                  <a href="assets/img/Brainstorm.jpg" class="portfolio-single"><i class="fa fa-search-plus"></i></a>-->
      <!--                              </div>-->
      ...
      <!--                  </div>-->
						<div class="col-md-3 col-sm-6 col-xs-12 padding grid-item transition">
                            <div class="portfolio-single-item">
                                ...
                                <div class="portfolio-overlay">
                                    <div class="zoom">
                                        <a href="assets/img/Staff.jpg" class="portfolio-single"><i class="fa fa-search-plus"></i></a>
                                    </div>
