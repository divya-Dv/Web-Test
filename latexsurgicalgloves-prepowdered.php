    ...
    <script type="application/ld+json">
        {
            "@context": "https://schema.org/",
            "@type": "Product",
            "name": "DR Glove - Powdered Latex Surgical Glove",
            "image": "https://www.vlhsglove.com/img/prepowder.jpg",
            "description": "Discover DR Glove's Powdered Latex Surgical Glove, designed for comfort, durability, and excellent tactile sensitivity. Perfect for medical purpose",
            "brand": {
                "@type": "Brand",
                "name": "Vijayalakshmi Health & Surgicals Pvt Ltd"
            },
                        ...
                        <div class="titlebar">
                            ...
                            <div class="nx-breadcrumb"><!-- Breadcrumb NavXT 6.1.0 -->
                                <span property="itemListElement" typeof="ListItem">
                                    ...
                                    <span property="name">Latex Surgical Gloves – Pre Powdered</span>
    ...
    <section class="service-details section-padding">
        <div class="container">
            <div class="row">
                ...
                <!--        <img src="img/prepowder.jpg" alt="Orthopedic Gloves in UK" class="responsive"-->
                ...
                <div class="col-md-8">
                    <div class="service-details-area">
                        <p style="padding-top:18px;">Surgical Gloves are well designed for surgeons featuring the
                            outstanding fit, comfort, performance, latest technology and quality assurance.</p>
                        <br>
                        <ul class="list">
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i> Extra
                                strength provides additional protection from surgical debris</li>
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i> Curved
                                fingers reduce hand fatigue while the beaded cuffs prevent roll-back and make gloves
                                easy to put on</li>
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i> Low powder
                                content that minimizes skin irritation</li>
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i> Their
                                anatomical shape makes them fit better, especially for in-between sizes</li>
                        </ul>
                        ...
                        <ul class="list">
                            ...
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i>
                                Indian Medical Device Regulation (IMDR) 2017 - Class B Device.</li>
                            ...
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i>
                                Using US FDA approved absorbable USP Grade modified corn starch.</li>
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i>
                                Bio burden and sterility tested.</li>
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i>
                        ...
                        <div class="tab-pane fade active in" id=bs_first_tab25>
                            <table border="0" width="100%" cellspacing="1" cellpadding="5">
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Powder</th>
                                        <td> US FDA approved USP grade Bio-absorbable cornstarch and Powder content is
                                            &lt; 15 mg/dm2.</td>
                                    </tr>
                                    <tr>
                                        <th>Storage</th>
                                        <td>The gloves shall maintain their properties when stored in a dry condition at a temperature not higher than 30°C. Avoid direct sunlight.</td>
                                    </tr>
                                    <tr>
                                        <th>Sterilization</th>
                        ...
                        <div class="tab-pane fade " id=bs_tab121340625>
                            <table class="table-list">
                                <tbody>
                                    ...
                                    <tr>
                                        <th rowspan="8" scope="row" align="left">Width (mm)</th>
                        ...
                        <div class="tab-pane fade " id=bs_tab123738425>
                            <table class="table-list">
                                <tbody>
                                    ...
                                    <tr>
                                        <th colspan="2" scope="row" align="left">Powder Content</th>
