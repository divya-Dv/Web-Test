        ...
        <section class="medipath-banner">
            ...
            <div class="container">
				...
				<div class="titlebar">
				  ...
				  <span property="name">Careers</span><meta property="position" content="2"></span></div>
...
<div class="moreinfo" style="display:none;">
				 ...
				 <ul class="list jobli" style="padding-left:30px;">
				    <li>Good hands-on experience in Operation and maintenance (Preventive, breakdown and overhauling) of various equipments like Chain conveyor system, Thermic fluid heater, Screw air compressors, Water Chillers, Diesel generators, ETO sterilization, Heat exchangers and Tumblers.</li>
                    <li>Ability to guide the team and train them as required.</li>
                    <li>Experience in Latex Glove manufacturing industry is preferrable.</li>
			 ...
			 <br>
				<a href="applyonline.php"><button type="button" class="btn btn-primary">Apply Now</button></a>
					<br>
					</div>
				
					<hr>
					 <h3 style="color:#00a651;"> Production Manager (Overall 6 to 8 years of experience in Latex Glove manufacturing)</h3>
					 <p>Experienced in Latex Glove Manufacturing.&nbsp;  <a class="read2" href="javascript:void(0);">Read More</a></p>
				 <br>
<div class="moreinfo2" style="display:none;">
				 <p><b>Qualification</b></p>
				 <ul class="list jobli" style="padding-left:30px;">
				     <li>Should have a degree in Polymer Technology or Rubber Technology or Science
Graduate/Post Graduate.</li>

				 </ul>
				  <p><b>Key Skills Required</b></p>
				 <ul class="list jobli" style="padding-left:30px;">
				     <li>Should have at least 3 years of experience as production in-charge in <b>Latex
Glove Manufacturing Plant</b> </li>
<li>Knowledgeable in production planning and meeting monthly targets</li>
<li>Excellent Leadership capability</li>
<li>Should be aware of quality requirements of <b>Surgical Glove - Pre Powdered and Powder Free (Polymer Coated)</b>.</li>
<li>Good understanding of ISO and CE certification standards. Ability to identify non-
conformance and implement corrective and preventive actions</li>
<li>Should have excellent troubleshooting skills on production issues and ability to guide
the team</li>
<li>Knowledge on Nitrile glove manufacturing will be added advantage</li>
<li>Experience abroad will be an added advantage.</li>
<li>Good Communication ability, both in written and spoken English and Hindi</li>
				 </ul>
				 ...
				 <ul class="list jobli" style="padding-left:30px;">
				    <li>End to End production planning and management</li>
                    <li>Raw material planning</li>
                    <li>Production shift planning and Handle large work force on the production floor</li>
                    <li>Motivate the team to achieve results</li>
                    <li>Implementing innovative ideas to improve the glove quality and reduce wastage</li>
                    <li>Timely coordination with purchase for raw material procurement</li>
                    <li>Willing to work in a different work culture</li>
                    <li>Maintain the required production reports and dashboards for management</li>
			 ...
			 <br>
				<a href="applyonline.php"><button type="button" class="btn btn-primary">Apply Now</button></a>
					...
					<hr>
                 <h3 style="color:#00a651;">QC LAB ASSISTANT (2+ YEARS)</h3>
				 <p><b>Key Skills</b> : Lab Quality Assurance, RM Testing and Analysis, Stability test.  &nbsp; <a class="read3" href="javascript:void(0);">Read More</a></p>
				 <div class="moreinfo3" style="display:none;">
				 <p><b>Education</b> : B.Sc/M.Sc (Chemistry)</p>
				 <h3>Job Description</h3>
					...
					<hr>
				      ...
				      <h3>Job Description</h3>
				          <ul class="list" style="padding-left:30px;">
			                 ...
			                 <li>5. Ensure legal compliance</li>
