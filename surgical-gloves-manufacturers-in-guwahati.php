...
<!-- End Google Tag Manager -->
        <!-- page title -->
        <title>DR Glove - Surgical Gloves Manufacturers In Guwahati</title>
...
<meta property="og:description" content="Discover the high quality surical gloves from Vijayalakshmi Health & Surgicals Pvt Ltd and get exciting deals on our products visit us for deatils.">
		...
		<meta name="description" content="Premium Surgical Gloves Manufacturers In Guwahati. Our gloves ensure superior protection and comfort for medical professionals. Explore our range call."/>
		
        <link rel="canonical" href="https://www.vlhsglove.com/surgical-gloves-manufacturers-in-guwahati.php" />
        <!--Bootstrap css-->
...
<!-- End Google Tag Manager (noscript) -->
       ...
       <section class="medipath-banner">
            ...
            <div class="container">
				...
				<div class="titlebar">
					 <h1 class="entry-title">Surgical Gloves Manufacturers In Guwahati</h1>
				  ...
				  <span property="name">Surgical Gloves Manufacturers In Guwahati</span><meta property="position" content="2"></div>
                ...
                <div class="row">
                    <div class="col-md-5 img_col" style="padding-top:20px;">
                        <div class="medipath-details-img">
                            <img src="../img/prepowder1.jpg" class="img-responsive" alt="Surgical Gloves Manufacturers In Guwahati" title="Surgical Gloves Manufacturers In Guwahati">
                    ...
                    <div class="col-md-7 text_col">
                        <div class="medipath-details">
							...
							<h2>Surgical Gloves Manufacturers In Guwahati</h2>
                            <p>Improve medical outcomes and contribute towards the advancement of medical science with the help of the most renowned and objective-driven <b>surgical gloves manufacturers in Guwahati</b>. Incorporated in 2011, <a href= index,php><b>Vijayalakshmi Health and Surgical Pvt. Ltd</b> Glove</a> has become a name to be reckoned with in the market when it comes to high-quality surgical gloves for a wide range of medical applications. Some of our products include latex surgical gloves – powder free, latex surgical gloves – pre-powdered, nitrile examination gloves, etc. Each pair of our gloves is crafted with utmost care to meet all relevant industry standards of performance, quality, and reliability.</p>
<p style="margin-top: 15px;">Our goal is to empower healthcare providers so they can provide care with confidence and help improve overall health outcomes across the board. Here is why we are considered one of the top-tier <b>surgical gloves manufacturers in Guwahati:</b></p>
<ul class="ul_list" style="padding-left:20px; margin-top: 15px;">
<li><b>Quality Compliance:</b> Our production process is exemplified by strict adherence to a slew of quality regulations depending on the client and region we serve. We ensure that every product undergoes rigorous checks to ensure each pair is durable and functional. Some of our quality accreditations include CE Certification, EN ISO-13485:2016, and ISI Certification.</li>
</ul>
                         </div>
                    </div>
...
<ul class="ul_list" style="padding-left:20px; margin-top: 15px;">
<li><b>High Calibre Team:</b> Our team is made up of both experienced professionals and new joiners. The goal is to build a synergy that gets amplified over time which shows in our output and work culture. Each member’s task is cut out for them and they work diligently to ensure it is completed as expected.</li>
<li><b>Customisation:</b> In addition to offering a variety of surgical gloves based on the particular medical application, we also have the provision to custom-build the gloves to meet the users’ specific requirements.</li>
<li><b>Customer-Focus:</b> Everything we do is with our customers in focus. We go to great lengths to ensure we deliver high-quality products while also delivering a seamless experience that forges long-lasting association.</li> 
</ul>
<p style="margin-top: 15px;">For the most prolific <b>surgical gloves manufacturers in Guwahati</b>, head to <b>Vijayalakshmi Health and Surgical Pvt. Ltd</b> Glove right away.</p>
<p style="margin-top: 15px;"><b>Related Links:</b> <a href= surgical-gloves-manufacturers-in-pune.php>Surgical Gloves Manufacturers In Pune</a></p>
                </div>
            </div>
        </section>
