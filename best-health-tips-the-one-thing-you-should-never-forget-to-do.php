            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="medipath-banner-header">
                        <h1 class="banner-title">Best Health Tips: The one thing you should never forget to do</h1>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                            <li class="breadcrumb-item active">Best Health Tips: The one thing you should never forget to do</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-7 text_col">
                    <div class="medipath-details">
                        <div class="medipath-Welcome">
                            ...
                            <p>A healthy mind and body is the sum total of many mindful activities we commit to on any given day. Granted, we can still live a fairly healthy life even if we skip a thing or two from the checklist of healthy activities. However, there is one thing in our list you should never ever skip – and that is to drink a sufficient amount of water daily. An adult requires at least 1.5 litres of water daily. 70% of our body is composed of water. That itself explains a lot without giving further explanation as to why water is important for our survival and why we should not be skipping this little task on any given day.</p>
                            <br>
                            <p>Here’s why it is beneficial:</p>
                            <ul class="ul_list" style="padding-left:20px;">
                                <li>Essential for all organs to perform its assigned tasks.</li>
                                <li>Lubricates the joints.</li>
                                <li>Keeps the eyes, nose, and mouth moist.</li>
                                <li>Blood is 90% water.</li>
                                <li>Carries oxygen and other nutrients across all parts of the body.</li>
                                <li>Bowel system needs water to function optimally. </li>
                                <li>Maintains blood pressure.</li>
                                <li>Flushes body waste in the form of urine and faeces.</li>
                                <li>Dissolves minerals and other nutrients into the blood.</li>
                                <li>Helps the kidney to function properly.</li>
                                <li>Helps in regulating body weight.</li>
                                <li>It provides support to the brain and other sensitive tissues.</li>
                            </ul>
                        </div><br>
                        <p>Need we explain anymore why you shouldn’t be skipping this one little activity in your daily routine?</p>
                    </div>
                </div>
