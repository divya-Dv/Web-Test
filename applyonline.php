...
<body>
    ...
    <!-- Google Tag Manager (noscript) -->
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KNPH49N"
            height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
    <!-- End Google Tag Manager (noscript) -->
    <!-- Google Tag Manager (noscript) -->
    ...
    <section class="medipath-banner">
            ...
            <div class="container">
				...
				<div class="titlebar">
				  ...
				  <span property="name">Apply Online</span><meta property="position" content="2"></span></div>
    ...
    <!--Satrt appoinment-area area -->
    <section class="appoinment-area section-padding">
        <div class="container">
            <!---<div class="row">
                    <div class="medipath-title text-center">
                        <h2 class="text-capitalize">make an appoinment</h2>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="appoinment-form">
                        <form name="sentMessage" method="post" action="careermail.php" enctype="multipart/form-data">

                            <div class="form-group col-md-6" style="width:570px;">
                                <label for="email">Job Postion <b style="color:red;">*</b></label>
                                <select class="form-control" name="position">
                                    ...
                                    <option value="QC Lab Assistant">QC Lab Assistant</option>
                                    <option value="QA Assistant">QA Assistant</option>
                                    <option value="Packing And Dispatch Incharge">Packing And Dispatch Incharge</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="email">Your Name <b style="color:red;">*</b></label>
