...
<!-- End Google Tag Manager (noscript) -->
       ...
       <section class="medipath-banner">
            ...
            <div class="container">
				...
				<div class="titlebar">
					 <h1 class="entry-title">Micro Surgery Gloves Manufacturer</h1>		
				  ...
				  <span property="name">Micro Surgery Gloves Manufacturer</span><meta property="position" content="2"></div>
					 <div class="nx-breadcrumb"><!-- Breadcrumb NavXT 6.1.0 -->
                     <span property="itemListElement" typeof="ListItem">
