...
if($_POST['address']!=NULL){ $address=$_POST['address']; }
if($_POST['message']!=NULL){ $message=$_POST['message']; }

$originalname =  $_FILES['resume']['name'];
$ext = pathinfo($originalname, PATHINFO_EXTENSION);
$removedash = preg_replace("/\s+/", "_", $originalname);
$namei = pathinfo($removedash, PATHINFO_FILENAME);
$finalname = $namei."_".date("mjYHis").".". $ext;
$l="resumes/";
$d=$l.$finalname;
move_uploaded_file($_FILES['resume']['tmp_name'], $d);

if($email != NULL || $email != '' || $phone != NULL || $phone != '')
{
date_default_timezone_set("Asia/Kolkata");

$subject = 'Enquiry for VLHS Gloves';
        ...
        <tr>
            <td width="100%" align="center" valign="top">
                ...
                <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="container" bgcolor="ffffff">
                    ...
                    <tr bgcolor="ffffff">
                        <td height="40" style="text-align:center;"> Enquiry For VLHS Gloves </td>
                    </tr>
                    <tr>
                        <td>
                            <table border="0" width="560" align="center" cellpadding="0" cellspacing="0" class="container-middle">
...
CURLOPT_POST =&gt; true,
CURLOPT_POSTFIELDS =&gt; [
'secret' =&gt; '6LcMHHgjAAAAAO_jbiHlNqSeGC3phwbvJ9n--qG0',
...
echo "Captcha Verification Failed";
	...
	$mail = new PHPMailer();		
    	$mail-&gt;From      = 'noreply@vlhsglove.com';		
    	$mail-&gt;FromName  = "TD-G Rank-Enquiry";		
    	$mail-&gt;Subject   = $subject;		
    	$mail-&gt;Body      = $message;		
    	$mail-&gt;SetFrom( "noreply@vlhsglove.com", 'TD-G Rank-Enquiry');
    
    //  $mail-&gt;AddAddress('latha.grank@gmail.com', 'vlhs gloves');
  $mail-&gt;AddAddress('info@vlhsglove.com', 'vlhs gloves');    
  $mail-&gt;AddBCC('seo.grank@gmail.com','vlhs gloves');
  $mail-&gt;AddBCC('maheshwari@grank.co.in','vlhs gloves');
  $mail-&gt;AddCC('Arunreddy@grank.co.in','vlhs gloves');
   $mail-&gt;AddCC('leadtest@grank.co.in','vlhs gloves');
  
  $mail-&gt;addAttachment($d, $originalname);
 $mail-&gt;IsHTML(true);
