                        ...
                        <div class="titlebar">
                            ...
                            <div class="nx-breadcrumb"><!-- Breadcrumb NavXT 6.1.0 -->
                                <span property="itemListElement" typeof="ListItem">
                                    ...
                                    <span property="name">Certifications</span>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="medipath-Welcome">
                        <p>Undeterred Commitment to Excellence in Quality Standards have earned the prestigious and CE Certification along with EN ISO-13485:2016 (certifications of quality
                            management systems, specifically for medical devices) and have the India Bureau of
            ...
            <div class="row">
                    ...
                    <!-- <div class="col-md-3 col-sm-6 col-xs-12 padding grid-item metal">
                        <h4 class="color">ISO 9001-2015</h4>
                            <div class="portfolio-single-item"  style="border:1px solid blue;">
                               <a href="certifications/ISO-9001-2015.pdf" target="_blank"> 
                              <img src="assets\img\9001-2015.jpg" class="img-responsive" alt="ISO 9001-2015 Certificate"
                    ...
                    <!--	  <img src="assets\img\ISO-9001-2015.jpg" class="img-responsive" alt="Surgical Gloves Exports UK"-->
                    <!--		   height="800px;" width="200px;">-->
                    <!--		</a>-->
                    <!--                     </div>-->
                    <!--                  </div>-->

                    <div class="col-md-4 col-sm-6 col-xs-12 padding grid-item alkali">
                    ...
                    <!-- <div class="col-md-3 col-sm-6 col-xs-12 padding grid-item alkali">
                        <h4 class="color">ISI Certifications 2017</h4>
                            <div class="portfolio-single-item" style="border:1px solid blue;">
                              <a href="certifications/ISI-Certificate-2017.pdf" target="_blank">  
                                <img src="assets\img\bureau-2016-s.jpg" class="img-responsive" alt="Surgical Gloves Exports UK">
                              </a>
                           </div>
                        </div> -->

                    <!--<div class="col-md-3 col-sm-6 col-xs-12 padding grid-item alkali">-->
                    <!--<h4 class="color">ISI Certifications</h4>-->
                    <!--                      <div class="portfolio-single-item" style="border:1px solid blue;">-->
                    <!--                        <a href="certifications/new/ISI-Certification.pdf" target="_blank">  -->
                    <!--		<img src="assets\img\ISI.jpg" class="img-responsive" alt="ISI Certifications">-->
                    <!--	  </a>-->
                    <!--                     </div>-->
                    <!--                  </div>-->
                    <div class="col-md-4 col-sm-6 col-xs-12 padding grid-item alkali">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 padding grid-item transition">
                        <h4 class="color">Free Sales Certificate</h4>
                        <div class="portfolio-single-item" style="border:1px solid blue;">
                ...
                <!-- <div class="col-md-3 col-sm-6 col-xs-12 padding grid-item alkali">
                    <!--	  <h4 class="color">ISO 14001 2015</h4>-->
                <!--                       <div class="portfolio-single-item" style="border:1px solid blue;">-->
                <!--                          <a href="certifications/ISO-14001-2015.pdf" target="_blank"> -->
                <!--			  <img src="assets\img\bureau-4.jpg" class="img-responsive" alt="ISO 14001 2015 certificate">-->
                <!--			</a>-->
                <!--                      </div>-->
                <!--                   </div> -->
                ...
                <!--		  <img src="assets\img\ISO-14001-2015.jpg" class="img-responsive" alt="Surgical Gloves Exports UK">-->
                <!--		</a>-->
                <!--                     </div>-->
                <!--                  </div>-->

                <!-- <div class="col-md-3 col-sm-6 col-xs-12 padding grid-item transition">-->
                <!--<h4 class="color">Food Grade Certificate</h4>-->
                <!--                      <div class="portfolio-single-item" style="border:1px solid blue;">-->
                <!--                         <a href="certifications/FoodGrade-Certificate.pdf" target="_blank"> -->
                <!--		 <img src="assets\img\bureau-2.jpg" class="img-responsive" alt="Surgical Gloves Exports UK">-->
                <!--		</a>-->
                <!--                     </div>-->
                <!--                  </div>-->
                ...
                <!--<div class="col-md-3 col-sm-6 col-xs-12 padding grid-item transition">-->
                <!-- <h4 class="color">Good Manufacturing Practice</h4>-->
                <!--                 <div class="portfolio-single-item" style="border:1px solid blue;">-->
                <!--                      <a href="certifications/GMP1.pdf" target="_blank"> -->
                <!--	 <img src="assets\img\GMP.jpg" class="img-responsive" alt="Surgical Gloves Exports UK">-->
                <!--   </a>-->
                <!--                 </div>-->
                <!--               </div>-->
