<!DOCTYPE html><html lang="en"><head>
    ...
    <!-- End Google Tag Manager -->
    <!-- page title -->
    <title>DR Glove - Nitrile Examination Gloves Manufacturers In India</title>
...
<meta property="og:description" content="Discover the high quality surical gloves from Vijayalakshmi Health &amp; Surgicals Pvt Ltd and get exciting deals on our products visit us for deatils.">
    ...
    <meta name="description" content="Nitrile Examination gloves manufacturers in India. We provides you with the best quality and affordable glove. Reach us today for more information call">
    ...
    <link rel="canonical" href="https://www.vlhsglove.com/nitrileexaminationgloves.php">
    <!--Bootstrap css-->
    ...
    <script type="application/ld+json">
        {
            "@context": "https://schema.org/",
            "@type": "Product",
            "name": "DR Glove - Nitrile Examination Gloves Manufacturers In India",
            "image": "https://www.vlhsglove.com/img/prod-img6.jpg",
            "description": "Nitrile Examination gloves manufacturers in India. We provides you with the best quality and affordable glove. Reach us today for more information call",
            "brand": {
                "@type": "Brand",
                "name": "Vijayalakshmi Health & Surgicals Pvt Ltd"
            },
...
<body>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="iheader" style="">
                        <div class="titlebar">
                            <h1 class="entry-title">Nitrile Examination Gloves</h1>
                            <div class="nx-breadcrumb"><!-- Breadcrumb NavXT 6.1.0 -->
                                <span property="itemListElement" typeof="ListItem">
                                    ...
                                    <span property="name">Nitrile Examination Gloves</span>
                    ...
                    <!----<div class="medipath-banner-header">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Nitrile Examination Gloves</li>
                            </ol>
                        </div>-->
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="service-nav">
                        ...
                        <!--<img src="assets/img/nitrile-examination-gloves.jpg" alt="Nitrile examination gloves" class="responsive" height="360px;" width="370px;">-->
                        <picture><source srcset="img/320w/prod-img6_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="img/640w/prod-img6_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="img/1024w/prod-img6_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="img/1920w/prod-img6_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="img/prod-img6.webp" alt="Nitrile examination gloves" class="responsive" height="360px;" width="370px;" loading="lazy" decoding="async"></picture>
                        <!---<ul class="nav">
                ...
                <div class="col-md-8">
                    <div class="service-details-area">
                        <h3 style="color:#00a651;">FUNCTIONAL BENEFITS</h3>
                        <ul class="list">
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i> Protection from unwanted and dangerous substances.</li>
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i> Beaded cuff ensures easy donning and prevent roll down.</li>
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i> Superior strength with better puncture resistance.</li>
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i> Full textured enhances wet and dry grip.</li>
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i> Thinner gauger improves tactile sensitivity.</li>
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i> Custom design enhances comfort and fit.</li>
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i> Provide an alternative solution for individuals who are allergic to natural rubber latex.</li>

                        </ul>


                        <br>
                        <h3 style="color:#00a651;">QUALITY CONTROL</h3>
                        <ul class="list">
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i> 100% Inspected</li>
                            <li><i class="fa fa-play-circle-o" style="color:#cccece; padding-right:5px;"></i> AQL – 1.5</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div id="primary" class="content-area">
                            ...
                            <div class="col-sm-8">
                                <div class="tab_wrap">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a data-toggle="tab" href="#bs_first_tab25">Product Specifications</a></li>
                                        <li class=""><a data-toggle="tab" href="#bs_tab121340625">Dimension Properties</a></li>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade active in" id="bs_first_tab25">
                                            <table border="0" width="100%" cellspacing="1" cellpadding="5">
                                                <tbody>
                                                    <tr>
                                                        <th>Type</th>
                                                        <td>Nitrile Medical Examination Gloves, Powder Free</td>
                                                    </tr>
                                                    <tr>
                                                        <th>Material</th>
                                                        <td>Nitrile butadiene rubber (NBR)</td>
                                                    </tr>
                                                    <tr>
                                                        <th>Design &amp; Features</th>
                                                        <td>Ambidextrous, Straight Fingers, Beaded cuff, Blue Colour</td>
                                                    </tr>
                                                    <tr>
                                                        <th>Storage</th>
                                                        <td>The gloves shall maintain their properties when stored in a dry condition at temperature not higher than 30°C.</td>
                                                    </tr>
                                                    <tr>
                                                        <th>Shelf Life</th>
                                        ...
                                        <div class="tab-pane fade " id="bs_tab121340625">
                                            <table class="table-list">
                                                <tbody>
                                                    <tr>
                                                        <td style="background-color: #0095da; color: #fff;" scope="col"><strong style="color: #fff;">Dimension </strong></td>
                                                        <td style="background-color: #0095da; color: #fff;" scope="col"><strong>Small</strong></td>
                                                        <td style="background-color: #0095da; color: #fff;" scope="col"><strong>Medium</strong></td>
                                                        <td style="background-color: #0095da; color: #fff;" scope="col"><strong>Large</strong></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <th scope="row" align="left">Width (mm)</th>
                                                        <td>80 ± 10</td>
                                                        <td>95 ± 10</td>
                                                        <td>111 ± 10</td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row" align="left">Thickness (mm)</th>
                                                        <td></td>
                                                        <td></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row" align="left">Finger</th>
                                                        <td>Min 0.05</td>
                                                        <td>Min 0.05</td>
                                                        <td>Min 0.05</td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row" align="left">Palm</th>
                                                        <td>Min 0.05</td>
                                                        <td>Min 0.05</td>
                                                        <td>Min 0.05</td>
                                                    </tr>
                                        ...
                                        <div class="tab-pane fade " id="bs_tab123738425">
                                            <table class="table-list">
                                                <tbody>
                                                    <tr>
                                                        <th style="background-color: #0095da; color: #fff;" scope="col"><strong>Characteristics</strong></th>
                                                        <th style="background-color: #0095da; color: #fff;" scope="col"><strong>Before Ageing</strong></th>
                                                        <th style="background-color: #0095da; color: #fff;" scope="col"><strong>After Ageing</strong></th>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row" align="left">Tensile Strength (Mpa)</th>
                                                        <td>Min14</td>
                                                        <td>Min14</td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row" align="left">Elongation at Break (%)</th>
                                                        <td>Min 500</td>
                                                        <td>Min 400</td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row" align="left">Stress @ 500% Elongation (Mpa)</th>
                                                        <td>Max 6</td>
                                                        <td>N/A</td>
                                                    </tr>
                                                </tbody>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="city" name="city" required="">
                            ...
                            <div class="at-below-post-page addthis_tool" data-url="http://www.vlhsglove.com/nitrile-examination-gloves/"></div><!-- AddThis Share Buttons generic via filter on the_content -->
                        </div><!-- .entry-content -->
    ...
    <script>
        grecaptcha.ready(function() {
            grecaptcha.execute('6LcMHHgjAAAAAFcpRXf51KRhKtWcQ7geXadccppg', {
                action: 'homepage'
            }).then(function(token) {
                console.log(token);
